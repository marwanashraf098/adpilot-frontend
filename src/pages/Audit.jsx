...
function Audit() {
  ...
  const handleAudit = async (e) => {
    ...
    if (!form.facebook_page_url && !form.instagram_url && !form.tiktok_url && !form.website_url) {
    ...
    <div className="min-h-screen bg-[#0f172a] text-white font-sans">
      ...
      {step === 1 && (
        <section className="max-w-2xl mx-auto px-8 pt-20 pb-16 text-center">
          ...
          <p className="text-gray-400 text-lg mb-10">
            Enter your business details and online presence. Our AI analyzes your advertising strategy across all platforms and tells you exactly what to fix.
          </p>

          <form onSubmit={handleAudit} className="bg-white/5 border border-white/10 rounded-2xl p-8 text-left space-y-5">

            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                <label className="block text-sm text-gray-400 mb-2">Business name <span className="text-red-400">*</span></label>
                <input
                  type="text"
                  value={form.business_name}
                  onChange={(e) => setForm({...form, business_name: e.target.value})}
                  placeholder="e.g. Cairo Gym, Nour Clinic"
            ...
            <div className="border-t border-white/10 pt-5">
              <p className="text-sm text-gray-400 mb-4">Enter at least one platform URL <span className="text-red-400">*</span></p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-gray-800 flex items-center justify-center text-xs font-bold flex-shrink-0">TT</div>
                  <input
                    type="text"
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-green-600 flex items-center justify-center text-xs font-bold flex-shrink-0">W</div>
                  <input
                    type="text"
      ...
      {step === 2 && (
        <section className="max-w-2xl mx-auto px-8 pt-32 text-center">
          ...
          <p className="text-gray-400 mb-8">Our AI is reviewing your online advertising presence across all platforms</p>
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-left space-y-3">
            {[
              '✓ Checking platform presence',
              '✓ Analyzing ad account setup',
        ...
        <section className="max-w-3xl mx-auto px-8 pt-12 pb-20">
          ...
          <div className="bg-blue-600/10 border border-blue-500/20 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-400 mb-6 text-sm">
              AdPilot monitors your campaigns 24/7, fixes these issues automatically, and tells you exactly what to do next.
            ...
            <button
              onClick={() => { setStep(1); setAudit(null); setWaitlistDone(false) }}
