    ...
    <div className="min-h-screen bg-[#0f172a] text-white font-sans">
      ...
      <section className="bg-white/2 border-y border-white/5 py-20">
        <div className="max-w-5xl mx-auto px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Most businesses waste 40-60% of their ad budget</h2>
      ...
      <section id="how" className="py-20">
        <div className="max-w-5xl mx-auto px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">AdPilot works like a real media buyer</h2>
          <p className="text-gray-400 mb-14 max-w-xl mx-auto">It does everything a professional media buyer does — at a fraction of the cost</p>
        ...
        <div className="max-w-5xl mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold mb-4">Your AI startup consultant — from day one</h2>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={name} className="flex items-center justify-between">
                      ...
                      <span className={`text-xs px-2 py-0.5 rounded-full ${high ? 'bg-green-500/10 text-green-400' : 'bg-blue-500/10 text-blue-400'}`}>{badge}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section id="features" className="py-20">
        <div className="max-w-5xl mx-auto px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold mb-4">Everything your media buyer does — automated</h2>
        ...
        <div className="max-w-5xl mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold mb-4">Your creatives. Supercharged by AI.</h2>
              <p className="text-gray-400 leading-relaxed mb-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-4">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex items-center gap-3">
                <div className="w-12 h-12 rounded-lg bg-blue-600/20 border border-blue-500/20 flex items-center justify-center text-xl flex-shrink-0">📸</div>
                <div className="flex-1">
                  <p className="text-sm font-semibold">Summer_Campaign.jpg</p>
                  <p className="text-xs text-gray-500">Uploaded · 1080x1080</p>
                </div>
                <span className="text-xs bg-green-500/10 text-green-400 px-2 py-1 rounded-full">Top performer</span>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex items-center gap-3">
                <div className="w-12 h-12 rounded-lg bg-purple-600/20 border border-purple-500/20 flex items-center justify-center text-xl flex-shrink-0">🤖</div>
                <div className="flex-1">
                  <p className="text-sm font-semibold">AI Generated Visual</p>
                  <p className="text-xs text-gray-500">Generated · Ready to use</p>
                </div>
                <span className="text-xs bg-blue-500/10 text-blue-400 px-2 py-1 rounded-full">New</span>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex items-center gap-3">
                <div className="w-12 h-12 rounded-lg bg-red-600/20 border border-red-500/20 flex items-center justify-center text-xl flex-shrink-0">⚠️</div>
                <div className="flex-1">
                  <p className="text-sm font-semibold">Promo_Banner.jpg</p>
                  <p className="text-xs text-gray-500">Frequency 4.2 · CTR dropping</p>
                </div>
                <span className="text-xs bg-red-500/10 text-red-400 px-2 py-1 rounded-full">Refresh needed</span>
              </div>
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl font-bold mb-4">Everything a senior media buyer does — automated</h2>
      ...
      {/* You are in control */}
      <section id="control" className="bg-white/2 border-y border-white/5 py-20">
        <div className="max-w-5xl mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold mb-4">AI works for you. Not the other way around.</h2>
              <p className="text-gray-400 leading-relaxed mb-6">
      ...
      <section id="compare" className="py-20">
        <div className="max-w-4xl mx-auto px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold mb-4">AdPilot vs Marketing Agency</h2>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
            <div className="grid grid-cols-3 bg-white/5 px-6 py-4">
              ...
              <div className="text-sm font-semibold text-center text-gray-400">Marketing Agency</div>
              <div className="text-sm font-semibold text-center text-blue-400">AdPilot</div>
            </div>
            {[
              ...
              ['Seasonal campaign planning', 'If you remind them', 'Proactive, automatic'],
              ['Weekly performance reports', 'Monthly PDF', 'Every Monday on WhatsApp'],
              ['Business owner in control', 'Rarely', 'Always'],
              ['Managing ads', 'Complex ad managers', 'Simple dashboard — no experience needed'],
              ['Availability', 'Business hours only', '24/7'],
              ['Transparency', 'Limited data access', 'Full visibility'],
              ['WhatsApp alerts', '✗', '✓'],
            ].map(([feature, agency, adpilot], i) => (
              <div key={i} className={`grid grid-cols-3 px-6 py-4 ${i % 2 === 0 ? 'bg-white/2' : ''}`}>
                <div className="text-sm text-gray-300">{feature}</div>
                <div className="text-sm text-center text-gray-500">{agency}</div>
                <div className="text-sm text-center text-green-400 font-medium">{adpilot}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Final CTA */}
      <section id="waitlist" className="bg-blue-600/10 border-y border-blue-500/20 py-24">
        <div className="max-w-2xl mx-auto px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Be the first to try AdPilot</h2>
